...
if(isset($_POST['add_disease']))
{
    ...
    $dr2=  addslashes($dr1);
    $up=$_FILES['rpt']['name'];
    $sel_id=mysql_query("select * from hospital_disease_data");
    $count=  mysql_num_rows($sel_id);
    $num=$count+1;
    $ext1=  strrpos($up, ".");
    $ext=  substr($up, $ext1);
    $nfn="$num$ext";
    $ins_department=mysql_query("insert into hospital_disease_data VALUES('','".$_SESSION['hos']."','$dn','$dsn','$dr2','$nfn','0')");
    echo mysql_error();
    if($ins_department>0)
    {
        if(move_uploaded_file($_FILES['rpt']['tmp_name'],getcwd()."\\analyze_report\\$nfn"))
        {
            header("location:req_admin.php?success=1");
        }
    }
}
?>
						...
						<div class="row">
                                                    <div class="col-md-12 col-lg-12">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6">
                                                                            <div class="alert alert-warning">You can give request to Administrator for adding  Diseases which Not listed in the web site </div>
                                                                            <form method="post" enctype="multipart/form-data">
                                                                                ...
                                                                                <table class="table table-bordered table-hover table-responsive table-striped">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td>Analyzing Report</td>
                                                                                        <td><input type="file" name="rpt" class="form-control" required="required" /></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                            ...
                                                                            <script type="text/javascript">
                                                                                function get_desease(x)
                                                                                {
                                                                                    var xmlhttp = new XMLHttpRequest();
                                                                                                        ...
                                                                                                        xmlhttp.open("GET", "get_disease1.php?d=" + x, true);
                                                                                                        xmlhttp.send();
                                                                                }
                                                                            </script>
                                                                            <div id="ds">
                                                                        ...
                                                                        <div class="col-lg-6 col-md-6">
                                                                             <div class="alert alert-warning">The disease information posted by you is listed here . you can find the request status here. </div>
                                                                            <h3>Suggestion from you </h3>
                                                                               <?php
                                                                               $sel_ds=mysql_query("select * from hospital_disease_data,department_data where department_data.id=hospital_disease_data.dep and  hospital_disease_data.hid='".$_SESSION['hos']."' order by hospital_disease_data.id desc");
                                                                            ...
                                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                                ...
                                                                                <tr>
                                                                                    <td><?php echo $i ?></td>
                                                                                    <td><?php echo $r_ds[8] ?></td>
                                                                                    <td><?php echo $r_ds[3] ?></td>
                                                                                    <td style="text-align: justify;"><?php echo $r_ds[4] ?></td>
                                                                                    <td><center>
                                                                                        <?php
                                                                                        if($r_ds[6]==0)
                                                                                        {
                                                                            ...
                                                                            <?php
                                                                               ...
                                                                               {
                                                                                   ?>
                                                                            <div class="alert alert-danger">No Request from you</div>
                                                                            <?php
                                                                               }
                                                                               ?>
                                                                        </div>
