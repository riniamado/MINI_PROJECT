				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
                            ...
                            <?php
                            $sel_pat=mysql_query("select * from new_patient where h_id='".$_SESSION['hos']."' and dt1='".date('Y-m-d')."' order by st asc");
                            ...
                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><center>
                                        ...
                                        {
                                            ?>
                                        <span class="label label-danger" style="color: white" title="">Waiting</span></a>
                                        <?php
                                        }
                                        ?>
                                        <?php
