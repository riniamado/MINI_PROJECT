				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
                            ...
                            <?php
                            $sel_pat=mysql_query("select * from new_patient where h_id='".$_SESSION['hos']."' order by st asc");
                            ...
                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><center>
                                        ...
                                        {
                                            ?>
                                        <span class="label label-primary" onclick="shoopinfo('<?php echo $r_pat[0] ?>')" style="cursor: pointer;">Out Patient</span>
                                        <?php
                                        }
                                        if($r_pat[14]==2)
                                        {
                                            ?>
                                        <span class="label label-danger" onclick="shoadmitinfo('<?php echo $r_pat[0] ?>')" style="cursor: pointer;">Admitted..</span>
                                        <?php
                                        }
                                        ?>
                                        </center></td>
