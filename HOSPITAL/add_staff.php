...
if(isset($_POST['add_stf']))
{
    ...
    $pwd=$_POST['pwd'];
    $st=$_POST['st'];
    $ins_stf=mysql_query("insert into staff_data values('','".$_SESSION['hos']."','$sn','$uid','$con','$addr','$st','1')");
    echo mysql_error();
    if($ins_stf>0)
    {
        $ins_log=mysql_query("insert into usr_log values('','$uid','$pwd','$st','1')");
        if($ins_log>0)
        {
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                ...
                                                                <tr>
                                                                    <td>Password</td>
                                                                    <td><input type="password" name="pwd" class="form-control" required="required" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Staff Type</td>
                                                                    <td><select name="st" class="form-control" required="required">
                                                                            <option value="rec">Receptionist</option>
                                                                            <option value="aprm">Admitted Patient Report Maker</option>
                                                                        </select>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <h3>Available Staff List</h3>
                                                            <?php
                                                            $sel_stf=mysql_query("select * from staff_data where h_id='".$_SESSION['hos']."'");
