...
if(isset($_POST['add_dep']))
{
    ...
    {
        header("location:doc_list.php?dep=$dep");
    }
}
?>
<!DOCTYPE html>
                                                    ...
                                                    <div class="col-md-12 col-lg-12">                                                        
                                                           ...
                                                           if(isset($_GET['dep']))
                                                               ...
                                                               echo " <h3>Available Doctors :: $r_dep[1]</h3>";
                                                                                $sel_doc=mysql_query("select * from doc_data where h_id='".$_SESSION['hos']."' and dep='".$_GET['dep']."'");
                                                                            }
                                                                            else
                                                                            {
                                                           ...
                                                           if(mysql_num_rows($sel_doc)>0)
                                                           {
                                                            ...
                                                            <div class="col-lg-3"><center>
                                                                    <img src="doctor/<?php echo $r_doc[8] ?>" class="imh img-thumbnail" style="height: 200px" /><br /><?php echo $r_doc[2] ?>
                                                                </center></div>
                                                            <?php
                                                               }
                                                           }
