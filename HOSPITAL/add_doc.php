...
{
    $dep=$_POST['dep'];
    header("location:add_doc.php?dep=$dep");
}
if(isset($_POST['add_d']))
{
    ...
    $ddesig=$_POST['ddesig'];
    $up=$_FILES['up']['name'];
    $sel_id=mysql_query("select * from doc_data");
    ...
    $ins_doc=mysql_query("insert into doc_data values('','".$_SESSION['hos']."','$dn','$dem','$dcon','$fp','".$_GET['dep']."','$ddesig','$nfn','$qua','$dcons','1')");
    if($ins_doc>0)
    {
        if(move_uploaded_file($_FILES['up']['tmp_name'], getcwd()."\\doctor\\$nfn"))
        {
            $ins_log=mysql_query("insert into usr_log values('','$dem','$dpas','doc','1')");
            if($ins_log>0)
            {
                if(move_uploaded_file($_FILES['up1']['tmp_name'], getcwd()."\\doctor_fp\\$fp"))
                {
                    header("location:add_doc.php?dep=".$_GET['dep']);
                }                 
            }
                                                    ...
                                                    <div class="col-md-12 col-lg-12">
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                ...
                                                                <tr>
                                                                    <td>Email</td>
                                                                    <td><input type="text" name="dem" class="form-control" required="required" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Password</td>
                                                                    <td><input type="password" name="dpas" class="form-control" required="required" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Contact</td>
                                                                    <td><input type="text" name="dcon" class="form-control" required="required" /></td>
                                                                </tr>                                                               
                                                                <tr>
                                                                    <td>Department</td>
                                                                    <?php
                                                                    $sel_d=mysql_query("select * from department_data where id='".$_GET['dep']."'");
                                                                    $r_d=mysql_fetch_row($sel_d);
                                                                    ?>
                                                                    <td><input type="text" name="ddep" value="<?php echo $r_d[1] ?>" readonly="readonly" class="form-control" required="required" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Designation</td>
                                                                    <td><input type="text" name="ddesig" class="form-control" required="required" /></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>Photo</td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><input type="file" name="up1" class="form-control" required="required" /></td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    <td>Consulting Details</td>
                                                                    <td><textarea name="dcons" class="form-control" required="required"></textarea></td>
                                                                </tr>
                                                                <tr>
                                                                    <td colspan="2"><center><input type="submit" name="add_d" value="Add Doctor" class="btn btn-success" /></center></td>
                                                                </tr>
                                                            </table>
                                                            </form>
                                                            <?php
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                                                <tr>
                                                                    <td><select name="dep" class="form-control" required="required" style="width: 80%; float: left;">
                                                                            <option value="">Choose The Department you having</option>
                                                                            <?php
                                                                            $sel_dep=mysql_query("select * from department_data,hos_dep where department_data.id=hos_dep.dep_id and  hos_dep.h_id='".$_SESSION['hos']."'");
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                           ...
                                                           <?php
                                                           $sel_doc=mysql_query("select * from doc_data where h_id='".$_SESSION['hos']."' order by rand() limit 9");
                                                           if(mysql_num_rows($sel_doc)>0)
                                                           {
                                                            ...
                                                            <div class="col-lg-4"><center>
                                                                <img src="doctor/<?php echo $r_doc[8] ?>" class="imh img-thumbnail" /><br /><?php echo $r_doc[2] ?>
                                                                </center></div>
                                                            <?php
                                                               }
                                                           }
                                                           ?><br />
                                                            <a href="doc_list.php" class="btn btn-danger" style="float: right; margin-top: 10px;">View ALL</a>
                                                        </div>
                                                    </div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.page-content -->
