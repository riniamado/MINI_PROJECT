				...
				<div class="main-content-inner">
					...
					<div class="page-content">
                        ...
                        <div class="col-lg-6 col-md-6">
                         ...
                         if(isset($_GET['id']))
                         {
                             $sel_pat=mysql_query("select * from cit_data where bar_code='".$_GET['id']."'");
                         ...
                         <td><?php echo $r_pat[8] ?><br /><?php echo $r_pat[9] ?><br /><span class='fa fa-phone'></span><?php echo $r_pat[10] ?><hr />D.O.B : <?php echo $r_pat[13] ?><BR />Blood Group : <?php echo $r_pat[12] ?><br /><BR />
                             ...
                             <tr>
                                 <td colspan="2"><center>
                                 <a href="admin_report.php?id=<?php echo $_GET['id'] ?>&t=1"><span class="label label-warning">PREVIOUS TREATMENT HISTORY</span> </a>
                                 <a href="admin_report.php?id=<?php echo $_GET['id'] ?>&t=2"><span class="label label-primary">MEDICINE PURCHASE HISTORY</span> </a>
                                 <a href="admin_report.php?id=<?php echo $_GET['id'] ?>&t=3"><span class="label label-info">OLD LABORATORY REPORTS</span></a>
                             </center></td>                            
                         </tr>
                         <tr>
                             <td colspan="4"><center>
                                 <iframe src="amr/qrcode.php?id=<?php echo $_GET['id'] ?>" style="border:none; height: 90px; width: 90px;"></iframe>    
                         </center>
                             </td>
                         </tr>
                         </table>
                        ...
                        <div class="col-lg-6 col-md-6">
                            ...
                            if(isset($_GET['t']))
                            {
                                if($_GET['t']==1)
                                {
                                   $sel_admit=mysql_query("select * from new_patient where bar_code='".$_GET['id']."' order by id desc");
                            ...
                            <?php                                       
                                ...
                                if($_GET['t']==2)
                                {
                                   echo"<h3>Medicine Purchase Details</h3>";
                                        $sel_pr=mysql_query("select distinct dt from purchase_medicine where bar_code='".$_GET['id']."' order by id desc");
                                        ...
                                        <tr>
                                            <td><div style="cursor: pointer; background-color: #006dcc; color: white;" onclick="shosale1('<?php echo $i ?>')"><b><?php echo $r_pr[0] ?></b></div>
                                                <div id="a<?php echo $i ?>" style="display: none;">
                                                    <?php
                                                    $sel_det=mysql_query("select * from purchase_medicine where dt='$r_pr[0]' and bar_code='".$_GET['id']."'");
                                                    $j=1;
                                ...
                                if($_GET['t']==3)
                                {
                                    ...
                                    <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
                                        ...
                                        <?php
                                        $i=1;
                                        $sel_test=mysql_query("select * from purchase_lab where barcode='".$_GET['id']."' order by id desc");
