...
if(isset($_POST['add_cit']))
{
    ...
    $ps=$_POST['ps'];
    $descr=$_POST['desr'];
    $ins_cit=mysql_query("insert into cit_data values('','$nm','$sid','$did','$tid','$vid','$wn','$hn','$addr','$pin','$con','$nfn','$bg','$dob','$ps','$descr','$bar','$pas','0')");
    if($ins_cit>0)
    {
						...
						<div class="row">
                                                    <div class="col-md-12 col-lg-12">
                                                            ...
                                                            <table class="table table-bordered table-condensed table-hover table-striped">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        echo"$r_root[1]-$r_root[4]-$r_root[8]-$r_root[14]";
                                                                        ?>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            ...
                                                            <?php
                                                            $sel_cit=mysql_query("select * from cit_data where vid='$vid' order by id desc");
